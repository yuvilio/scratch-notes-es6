...
let pastEntries = [
  ...
  {
    input: './assets/js/basic-es6/02/002-classes.js',
    output: {
      file: './dist/assets/js/basic-es6/02/002-classes.js',
      format: 'iife',
      name: 'basicEs6Classes',
      sourcemap: true
    }
  },
  {
  ...
  {
    input: './assets/js/basic-es6/02/005-webpack-features.js',
    output: {
      file: './dist/assets/js/basic-es6/02/005-webpack-features.js',
      format: 'iife',
      name: 'basicEs6005WebpackFeatures',
      sourcemap: true
    }
  }
]
